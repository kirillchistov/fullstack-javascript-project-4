...
### Шаг 7
- [] Добавить библиотеку listr в проект, используйте флаг одновременной загрузки.
- [] Добавить отображение прогресса закачки ресурсов в терминал.
- [] Добавить в ридми аскинему с примером установки пакета и его работы. [Asciinema]()
### Шаг 6
